...
export function buildGeminiPrompt(formData: ScheduleFormData): string {
  ...
  return [
    ...
    '  { "title": string, "overview": string, "weeks": [ { "weekNumber": number, "focus": string, "days": [ { "day": string, "date"?: string, "type": string, "description": string, "intensity": string, "duration": string, "distance": string, "workoutDetails"?: WorkoutDetails } ] } ] }',
    "",
    ...
    '    "technicalData": { "rpe": number (1-10), "trainingEffect": string, "surface"?: string }',
    "  }",
    "",
