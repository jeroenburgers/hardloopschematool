      ...
      <div className="flex justify-end w-full sm:w-auto">
        <div className="flex flex-col items-end w-full sm:w-auto">
          {currentStep < maxStep ? (
            <button
              onClick={onNext}
              className="px-6 py-3 sm:px-8 sm:py-4 md:px-12 md:py-5 bg-orange-600 dark:bg-orange-500 text-white rounded-2xl sm:rounded-3xl font-black text-xs sm:text-sm uppercase tracking-[0.1em] hover:bg-orange-700 dark:hover:bg-orange-600 transition-colors shadow-[0_18px_45px_-20px_rgba(0,0,0,0.35)] active:translate-y-[1px] w-full sm:w-auto cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-zinc-950"
            >
