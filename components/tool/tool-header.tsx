...
export function ToolHeader() {
  ...
  return (
    <div className="mb-20 text-center">
      <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-zinc-950 dark:bg-zinc-900 text-white rounded-full text-[10px] font-black uppercase tracking-[0.3em] mb-8">
      ...
      <h1 className="text-5xl md:text-8xl font-black text-zinc-950 dark:text-zinc-50 tracking-tighter mb-6 leading-none">
        {toolTranslations.pageTitle}{" "}
        <span className="text-orange-600 dark:text-orange-500 italic">
          {toolTranslations.pageTitleHighlight}
        </span>
      </h1>
      <p className="text-zinc-400 dark:text-zinc-500 text-[11px] font-black uppercase tracking-[0.4em]">
